...
<div class="header">
    ...
    <div class="logo"><a href="${homeUrl}"><img src="<c:url value="/resources/images/logo.gif"/>" alt="" title=""
                                                border="0"/></a></div>
    <div class="nav">
        <ul style="float: left;">
            ...
            <sec:authorize access="isAuthenticated()">
                <li><a href="#" onclick="document.getElementById('logout').submit();"><spring:message
        ...
        <ul style="float: right;">
            ...
            <li><a href="?lang=en" class="selected"><img src="<c:url value="/resources/images/gb.gif"/>" alt="" title=""
                                                         border="0"/></a></li>
            <li><a href="?lang=nl"><img src="<c:url value="/resources/images/nl.gif"/>" alt="" title="" border="0"/></a>
            </li>
        </ul>
    </div>
</div>